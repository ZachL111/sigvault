...
`sigvault` is centered on security tooling work in Rust. The technical target is: Verify signed envelope canonicalization and replay guards.
...
The score is deterministic. The current threshold is 155. Risk has a penalty of 7, latency has a penalty of 3, and weight contributes a bonus of 6.

...
sigvault is a Rust project for security tooling. It focuses on this technical goal: Verify signed envelope canonicalization and replay guards.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 155, risk penalty 7, latency penalty 3, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.

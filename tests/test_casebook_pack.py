"""Regression checks for the sigvault casebook."""
...
from casebook.harness import assert_expected, sigvault_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(sigvault_summary(), assert_expected())

...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-sigvault-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-sigvault-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-sigvault-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-sigvault-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
